...
MUTANTS = [
    ...
    (
        "studio/planner.py",
        "            if свои and not условия_записи_в_брифе(запись, свои):",
        "            if False:",
        "ответ: чужая беда снова выдаётся за вашу — тамильский в русском заказе без оговорки",
    ),
    (
        "studio/planner.py",
        "            if свои and not условия_записи_в_брифе(запись, свои):",
        "            if свои:",
        "ответ: оговорка ставится всегда — заказчик, просящий телугу, её не отличит",
    ),
    (
        "studio/planner.py",
