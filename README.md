...
**957 tests in 23 files, no network, no GPU.** Run of 2026-09-01, quoted verbatim:

```
Ran 957 tests in 44.7s
...
**957 тестов в 23 файлах, без сети и без GPU.** Прогон 2026-09-01, вывод дословно:
