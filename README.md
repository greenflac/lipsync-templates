...
**1057 tests in 22 files, no network, no GPU.** Run of 2026-08-28, quoted verbatim:

```
Ran 1057 tests in 90.8s
...
**1057 тестов в 22 файлах, без сети и без GPU.** Прогон 2026-08-28, вывод дословно:
