...
**953 tests in 23 files, no network, no GPU.** Run of 2026-08-31, quoted verbatim:

```
Ran 953 tests in 42.8s
...
**953 теста в 23 файлах, без сети и без GPU.** Прогон 2026-08-31, вывод дословно:
