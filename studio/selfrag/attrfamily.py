...
СЕМЬИ: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "license": {
        ...
        # НЕГАТИВНЫЙ КОНТРОЛЬ ЛИЦЕНЗИОННОЙ СЕМЬИ (И5). `portal_license` — это
        # условия ПЕРЕПРОДАЖИ площадкой, а не лицензия весов: на fal.ai все 57
        # карточек помечены `commercial`, и у модели, чьи веса лежат под
        # «research only», такой ответ дал бы ложный зелёный на правиле Ц5
        # (лицензия читается ДО встраивания). Разобрано при заведении канала
        # портала 2026-09-02.
