...
# DEBT(2026-08-31): «append-only» здесь объявлено словами и ничем не
# удерживается (нарушение Ц7). Журнал в репозитории переписывался целиком
# ДВАЖДЫ за эту сессию — когда менялась семантика поля `known`, — то есть
# правило нарушал его же автор, и ни гейт, ни проверка этого не заметили;
# нашла независимая проверка, сверив значения вручную. Честный сторож должен
# сравнивать файл с его же предыдущей версией и краснеть на изменённой строке.
